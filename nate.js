// google docs spreadsheet templates can be found here:
// with refresh button:
// https://drive.google.com/previewtemplate?id=0Apa3f8UbEgEodEJFVDd2VUNEaWY1UjhUbGN4VExVWmc&mode=public
//
// without refresh button:
// https://drive.google.com/previewtemplate?id=0Apa3f8UbEgEodDY4aDE0RUh4Q1BNN0pDMzhTTGJZLXc&mode=public
//
/* ***********************************
...
//Getting rid of any sort of pesky no width white spaces we may run into
  ...
  if(toon.class == "1")  { class = "Warrior"; }
    ...
    /* User does not want this section so it is being removed for this version
    var totalAudit = 0;
    var auditInfo ="\u2063";
    ...
    // new variables for this custom version
    var neckEnchant = "\u2063";
    var backEnchant = "\u2063";
    var ring1Enchant = "\u2063";
    var ring2Enchant = "\u2063";
    ...
    //cheap (breath) enchants and gems
    ...
    //expensive (gift) enchants and gems
