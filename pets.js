...
//Lets go through that json array  
 ...
 var arrayCounter = petBattleArray.length;
  ...
  var thumbnail = "http://"+region+".battle.net/static-render/"+region+"/"+  toon.thumbnail;
    ...
    var numbersArray = new Array(toon.pets.numCollected, needUpgrade, needLevel, levels, battlePet);
  var wordsArray = new Array("Collected", "Fav Need Upgrade", "Num Favs to Level", "Fav Lvls Needed", "Total WildPets");
    
    var petInfo = new Array(
      wordsArray,      numbersArray, smallArrayQ, smallArrayQW, smallArrayL, smallArrayLW, smallArrayAll, thumbnail      
