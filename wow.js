...
function wow(region, toonName, realmName) {
  ...
  if (toon.class == "1") {
    class = "Warrior";
  } else if (toon.class == "2") {
    class = "Paladin";
  } else if (toon.class == "3") {
    class = "Hunter";
  } else if (toon.class == "4") {
    class = "Rogue";
  } else if (toon.class == "5") {
    class = "Priest";
  } else if (toon.class == "6") {
    class = "DeathKnight";
  } else if (toon.class == "7") {
    class = "Shaman";
  } else if (toon.class == "8") {
    class = "Mage";
  } else if (toon.class == "9") {
    class = "Warlock";
  } else if (toon.class == "10") {
    class = "Monk"
  } else if (toon.class == "11") {
    class = "Druid"
  } else {
    class == "Broken"
  }
  ...
  for (i = 0; i < stuff; i++) {
    if (toon.achievements.achievementsCompleted[i] == '9046') {
      heroicsProg++;
    }
    if (toon.achievements.achievementsCompleted[i] == '9049') {
      heroicsProg++;
    }
    if (toon.achievements.achievementsCompleted[i] == '9053') {
      heroicsProg++;
    }
    if (toon.achievements.achievementsCompleted[i] == '9054') {
      heroicsProg++;
    }
    if (toon.achievements.achievementsCompleted[i] == '9047') {
      heroicsProg++;
    }
    if (toon.achievements.achievementsCompleted[i] == '8844') {
      heroicsProg++;
    }
    if (toon.achievements.achievementsCompleted[i] == '9052') {
      heroicsProg++;
    }
    if (toon.achievements.achievementsCompleted[i] == '9055') {
      heroicsProg++;
    }
  ...
  var toonInfo = new Array(
    ...
    profession1, profession2, missingGlyphs, auditInfo
